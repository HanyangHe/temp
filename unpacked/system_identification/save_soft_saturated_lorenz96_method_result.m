function [methodResult, outputInfo] = save_soft_saturated_lorenz96_method_result( ...
...
%SAVE_SOFT_SATURATED_LORENZ96_METHOD_RESULT Persist one method independently.
%
...
% KAN, or SINDy field, and vice versa.
    ...
    methodRecord = struct();
    methodRecord.schemaVersion = 'soft_saturated_lorenz96_method_record_v1';
...
function indexPath = update_method_index_local(sampleOutputDir,methodPath,record,artifactInfo)
    ...
    methodIndex = struct();
    methodIndex.schemaVersion = 'soft_saturated_lorenz96_method_index_v1';
...
% contain different optional fields.
    ...
    methodArchive.schemaVersion = 'soft_saturated_lorenz96_method_archive_v1';

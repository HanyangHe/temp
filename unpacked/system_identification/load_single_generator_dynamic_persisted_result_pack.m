function [resultPack, loadInfo] = load_single_generator_dynamic_persisted_result_pack( ...
    sourceRoot,roundIndex,nTrain,strictMode)
%LOAD_SINGLE_GENERATOR_DYNAMIC_PERSISTED_RESULT_PACK Merge saved method records.
%
...
%   4) aggregate summary/single_generator_dynamic_results.mat.
%
...
% fallback to the aggregate archive or another independent method file.
    ...
    aggregatePath = fullfile(sourceRoot,'summary','single_generator_dynamic_results.mat');
    ...
    methodFields = {'phdn_g1','stage0sr_g1','phdn_g2','stage0sr_g2', ...
        'phdn_g3','stage0sr_g3','phdn','stage0sr','mlp','eql','kan','sindy'};

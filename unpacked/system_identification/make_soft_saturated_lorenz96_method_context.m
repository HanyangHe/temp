function context = make_soft_saturated_lorenz96_method_context( ...
...
%MAKE_SOFT_SATURATED_LORENZ96_METHOD_CONTEXT Build a self-contained record context.
%
...
% aggregate result_pack.mat produced by a different run.
    ...
    context = struct();
    context.schemaVersion = 'soft_saturated_lorenz96_experiment_context_v1';
    ...
    context.identifiers.caseName = text_field_local(task,'name','SoftSaturatedLorenz96');

function rollout = evaluate_single_generator_dynamic_rollout(task, methodName, methodResult)
%EVALUATE_SINGLE_GENERATOR_DYNAMIC_ROLLOUT Fixed-step ODE4 unseen-IC test.
%
...
% vector field from forcing an adaptive solver into arbitrarily small steps.
    ...
    [predictFcn, predictorInfo] = make_single_generator_dynamic_predictor(methodName, methodResult);
    rollout = struct();
    ...
    if predictorInfo.compiled && isfield(predictorInfo, 'referencePredictFcn') && ...
        ...
        try
            ...
            if ~isfinite(maxAbsDifference) || ~isfinite(maxRelDifference) || ...
                ...
                warning('SingleGeneratorDynamic:CompiledPredictorMismatch', ...
            ...
            warning('SingleGeneratorDynamic:CompiledPredictorCheckFailed', ...

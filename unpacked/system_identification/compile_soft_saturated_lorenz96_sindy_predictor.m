function compiled = compile_soft_saturated_lorenz96_sindy_predictor(resultSindy)
%COMPILE_SOFT_SATURATED_LORENZ96_SINDY_PREDICTOR Compile active SINDy terms once.
%
...
function [maxAbsError, maxRelError, nProbe] = validate_compiled_sindy_local(compiled, resultSindy, nx)
    ...
    Ycompiled = predict_compiled_soft_saturated_lorenz96_sindy(compiled, Xprobe);

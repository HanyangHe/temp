function outputInfo = save_soft_saturated_lorenz96_sample_outputs( ...
    outputDir,resultPack,task,samplingPlan,roundIndex,sampleRows, ...
    trajectoryFigure,trajectoryFigureData)
%SAVE_SOFT_SATURATED_LORENZ96_SAMPLE_OUTPUTS Persist one N/round result.
%
...
% (roundIndex,nTrain,method) for the same reason.
    ...
    [persistedPack,~] = load_soft_saturated_lorenz96_persisted_result_pack( ...
...
function reportPaths = write_recorded_reports_local(outputDir,resultPack)
    ...
    methodMap = { ...
        'phdn_g1','PhDN_G1'; 'phdn_g2','PhDN_G2'; 'phdn_g3','PhDN_G3'; ...
        'stage0sr_g1','Stage0SR_G1'; 'stage0sr_g2','Stage0SR_G2'; ...
        'stage0sr_g3','Stage0SR_G3'; 'mlp','MLP'; 'eql','EQL'; ...
        'kan','KAN'; 'sindy','SINDy'; 'neural_sindy','NeuralSINDy'};

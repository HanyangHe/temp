function [fig,figureData,summaryTable] = plot_single_generator_dynamic_noise_robustness(rows,varargin)
%PLOT_SINGLE_GENERATOR_DYNAMIC_NOISE_ROBUSTNESS Manuscript robustness figure.
%
...
% rounds. OOD and rollout metrics are intentionally excluded.
    ...
    % The clean PhDN-G3 point is near machine precision and would otherwise
    % compress the scientifically relevant noisy regime.  Keep SR-G3 visible
    % while clipping only the near-machine-precision final PhDN-G3 clean point.
    ...
    for iMethod = 1:numel(methods)
        ...
        errorbar(ax,S.noisePercent,S.idRMSEMean,lowerErr,upperErr, ...
            ...
            'LineWidth',1.4,'MarkerSize',5,'DisplayName',legendName);
    end
    ...
    figureData.yAxisTruncatedForCleanG3 = true;

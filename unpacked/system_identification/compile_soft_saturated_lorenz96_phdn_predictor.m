function compiled = compile_soft_saturated_lorenz96_phdn_predictor(methodResult)
%COMPILE_SOFT_SATURATED_LORENZ96_PHDN_PREDICTOR Compile fixed value-only PhDN inference.
%
...
%VALIDATE_COMPILED_PHDN_LOCAL Compare against the original fixed model once.
    ...
    Ycompiled = predict_compiled_soft_saturated_lorenz96_phdn(compiled, Xprobe);

function resultMlp = run_soft_saturated_lorenz96_mlp_baseline_from_phdn_result(resultPhdn, mlpOpts)
%RUN_SOFT_SATURATED_LORENZ96_MLP_BASELINE_FROM_PHDN_RESULT Case-local MLP sweep.
    ...
    resultMlp = train_soft_saturated_lorenz96_mlp_sweep_baseline( ...
    ...
    if getfield_default_local(mlpOpts,'verbose',true)
        print_soft_saturated_lorenz96_mlp_result(resultMlp);
    end
end

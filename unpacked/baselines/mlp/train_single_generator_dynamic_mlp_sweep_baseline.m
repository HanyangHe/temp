function result = train_single_generator_dynamic_mlp_sweep_baseline(XTrain, YTrain, XVal, YVal, XTest, YTest, XOod, YOod, mlpOpts)
%TRAIN_SINGLE_GENERATOR_DYNAMIC_MLP_SWEEP_BASELINE Sweep KAN-paper MLP structures in Python.
    ...
    adapterPath = fullfile(mlpDir, 'kan_paper_mlp_adapter_single_generator.py');
    cfg = struct();

function print_soft_saturated_lorenz96_kan_result(result)
%PRINT_SOFT_SATURATED_LORENZ96_KAN_RESULT Print accuracy-first SI KAN result.
    fprintf('\n========================================\n');
    ...
    if isfield(result,'gridStopReason')&&~isempty(result.gridStopReason)
        fprintf('Grid stop reason              : %s\n',result.gridStopReason);
    end

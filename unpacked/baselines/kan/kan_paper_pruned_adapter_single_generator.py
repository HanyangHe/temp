#!/usr/bin/env python3
"""Accuracy-first pyKAN sweep for the SingleGeneratorDynamic SI benchmark.
...
def _process_accuracy_checkpoint(
    ...
    *,
    accuracy_grid: int,
    accuracy_last_attempted_grid: int,
    base_source: str,
    accuracy_train,
    accuracy_val,
    base_stages,
    ...
    accuracy_branch.update(
        ...
        last_attempted_grid=int(accuracy_last_attempted_grid),
        grid_stop_reason=(
            str(base_stages[-1].get("stop_reason", ""))
            if base_stages and base_stages[-1].get("stop_reason", "")
            else "accuracy_validation_best_checkpoint"
        ),
    )
        ...
        if warm_path.is_file():
            ...
            try:
                ...
                warm_selected, _ = _process_accuracy_checkpoint(
                    ...
                    accuracy_last_attempted_grid=warm_last_grid,
    ...
    for depth in depths:
        ...
        try:
            ...
            chosen, _ = _process_accuracy_checkpoint(
                ...
                accuracy_last_attempted_grid=accuracy_last_grid,
                base_source="scratch",

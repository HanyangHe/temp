function resultKan=run_single_generator_dynamic_kan_baseline_from_phdn_result(resultPhdn,kanOpts)
%RUN_SINGLE_GENERATOR_DYNAMIC_KAN_BASELINE_FROM_PHDN_RESULT Case-local KAN sweep.
    ...
    resultKan=train_single_generator_dynamic_kan_sweep_baseline( ...
    ...
    if getfield_default_local(kanOpts,'verbose',true);print_single_generator_dynamic_kan_result(resultKan);end
end
